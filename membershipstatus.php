...
function membershipstatus_civicrm_managed(&$entities) {
  _membershipstatus_civix_civicrm_managed($entities);
}
 ...
 * @link http://wiki.civicrm.org/confluence/display/CRMDOC/hook_civicrm_caseTypes
 */
function membershipstatus_civicrm_angularModules(&$angularModules) {
_membershipstatus_civix_civicrm_angularModules($angularModules);
}
 ...
 */
function membershipstatus_civicrm_alterSettingsFolders(&$metaDataFolders = NULL) {
  _membershipstatus_civix_civicrm_alterSettingsFolders($metaDataFolders);
}
 ...
 *
function membershipstatus_civicrm_preProcess($formName, &$form) {
